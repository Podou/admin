define(['app'], function (app) {
  app.controller('DashboardMeController', ['breadcrumb', function(breadcrumb) {
    ...
    self.cocosToturial = [
      {
        name: '基礎Prefab教程 - 1 - 製作第一個Prefab',
        link: 'http://forum.cocos.com/t/cocoscreator-prefab-1-prefab/36136'
      }, {
        name: '基礎Prefab教程 - 2 - 用代碼進行控制',
        link: 'http://forum.cocos.com/t/cocoscreator-prefab-2/36150'
      }
    ];
  }]);
});
